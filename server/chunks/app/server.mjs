import { version, unref, inject, defineComponent, h, getCurrentInstance, onUnmounted, computed, ref, provide, shallowReactive, watch, Suspense, nextTick, Transition, hasInjectionContext, Fragment, mergeProps, useSSRContext, createApp, effectScope, reactive, shallowRef, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, isReadonly, Text, isRef, isShallow, isReactive, toRaw, withCtx } from 'vue';
import { d as useRuntimeConfig$1, $ as $fetch, h as createError$1, l as defu, m as sanitizeStatusCode, n as createHooks, o as getRequestHeaders, p as klona, q as parse$1, r as getRequestHeader, t as destr, v as isEqual$1, w as setCookie, x as getCookie, y as deleteCookie } from '../nitro/node-server.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/closes-oacv-TDL.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-3nb2g-tW.mjs').then((m) => m.default || m)
  },
  {
    name: "sneakers",
    path: "/sneakers",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/sneakers-svak0qPw.mjs').then((m) => m.default || m)
  }
];
...
const vueI18nConfigs = [
  () => import(
    './_nuxt/i18n.config-E-01vWQ1.mjs'
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404--_OLY6wq.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-5Vu2Ctqf.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-Swl1V9M2.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, useRouter as a, parseQuery$1 as b, createError as c, useRuntimeConfig as d, entry$1 as default, navigateTo as e, withoutTrailingSlash$1 as f, hasProtocol as h, injectHead as i, joinURL as j, nuxtLinkDefaults as n, parseURL as p, resolveUnrefHeadInput as r, useI18n as u, withTrailingSlash$1 as w };
